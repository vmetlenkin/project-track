    ...
    <div className="flex min-h-full bg-white">
      ...
      <div className="flex flex-1 flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 2xl:px-64 w-1/2">
        <div className="mx-auto w-full w-1/2">
            ...
            <div>
              ...
              <div className="relative mt-6">
                ...
                <div className="relative flex justify-center">
                  <span className="bg-white px-2 text-gray-500">Войти через соцсети</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            <button type="button"
                    className="text-white w-full justify-center bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
            ...
            <button type="button"
                    className="text-white w-full justify-center bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
              <svg className="mr-2 -ml-1 w-4 h-4" aria-hidden="true" focusable="false" data-prefix="fab"
            ...
            <button type="button"
                    className="text-white w-full justify-center bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
              <svg className="mr-2 -ml-1 w-4 h-4" aria-hidden="true" focusable="false" data-prefix="fab"
